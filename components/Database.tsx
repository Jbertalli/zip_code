    ...
    return (
        <>
            ...
            <List>
                ...
                <>
                    <ListItem disablePadding>
                        <ListItemButton onClick={() => {deleteAll(zip, city, latCoord, longCoord, state, stateAbbreviation), setUpdateAll(false), setUpdateZip(false), setUpdateCity(false), setUpdateLatitude(false), setUpdateLongitude(false)}}>
                            <ClearIcon fontSize="small" />&nbsp;
                            Delete All
                        </ListItemButton>
                    </ListItem>
                ...
                <>
                    <ListItem disablePadding>
                        <ListItemButton onClick={() => {addDocument(zip, city, latCoord, longCoord, OppLat, OppLong, state, stateAbbreviation), setUpdateAll(true), setUpdateZip(true), setUpdateCity(true), setUpdateLatitude(true), setUpdateLongitude(true)}}>
