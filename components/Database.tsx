        ...
        {updateZip ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteZip(zipName), setUpdateZip(false);
                }}
              >
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addZip(zipName), setUpdateZip(true);
                }}
              >
        ...
        {updateCity ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteCity(cityName), setUpdateCity(false);
                }}
              >
                <ClearIcon fontSize="small" />
                &nbsp; Delete City
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addCity(cityName), setUpdateCity(true);
                }}
              >
        ...
        {updateLatitude ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteLat(latitudeName), setUpdateLatitude(false);
                }}
              >
                <ClearIcon fontSize="small" />
                &nbsp; Delete Latitude
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addLat(latitudeName), setUpdateLatitude(true);
                }}
              >
                <HeightIcon
                  fontSize="small"
        ...
        {updateLongitude ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteLong(longitudeName), setUpdateLongitude(false);
                }}
              >
                <ClearIcon fontSize="small" />
                &nbsp; Delete Longitude
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addLong(longitudeName), setUpdateLongitude(true);
                }}
              >
        ...
        {updateAntinodeLatitude ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteOppositeLat(OppLatValueName),
                    setUpdateAntinodeLatitude(false);
                }}
              >
                <ClearIcon fontSize="small" />
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addOppLat(OppLatValueName), setUpdateAntinodeLatitude(true);
                }}
              >
        ...
        {updateAntinodeLongitude ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteOppositeLong(OppLongValueName),
                    setUpdateAntinodeLongitude(false);
                }}
              >
                <ClearIcon fontSize="small" />
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addOppLong(OppLongValueName),
                    setUpdateAntinodeLongitude(true);
                }}
              >
                <SyncAltIcon
                  fontSize="small"
        ...
        {updateState ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteState(stateName), setUpdateState(false);
                }}
              >
                <ClearIcon fontSize="small" />
                &nbsp; Delete State
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addState(stateName), setUpdateState(true);
                }}
              >
        ...
        {updateStateAbbreviation ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteAbbr(stateAbbreviationName),
                    setUpdateStateAbbreviation(false);
                }}
              >
                <ClearIcon fontSize="small" />
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addStateAbbr(stateAbbreviationName),
                    setUpdateStateAbbreviation(true);
                }}
              >
                <PlaceIcon
                  fontSize="small"
        ...
        {updateWeather ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteWeather(weatherDataName), setUpdateWeather(false);
                }}
              >
                <ClearIcon fontSize="small" />
                &nbsp; Delete Weather
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addWeather(weatherDataName), setUpdateWeather(true);
                }}
              >
                <WbSunnyIcon
                  fontSize="small"
        ...
        {updateCurrentTemp ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteCurrentTemp(currentTempDataName),
                    setUpdateCurrentTemp(false);
                }}
              >
                <ClearIcon fontSize="small" />
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addCurrentTemp(currentTempDataName),
                    setUpdateCurrentTemp(true);
                }}
              >
                <ThermostatIcon
                  fontSize="small"
        ...
        {updateTempRange ? (
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  deleteTempRange(tempRangeDataName), setUpdateTempRange(false);
                }}
              >
                <ClearIcon fontSize="small" />
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton
                onClick={() => {
                  addTempRange(tempRangeDataName), setUpdateTempRange(true);
                }}
              >
                <StraightenIcon
                  fontSize="small"
              ...
              <ListItemButton
                onClick={() => {
                  addDocument(
                    ...
                    setUpdateZip(true),
                    setUpdateCity(true),
                    setUpdateLatitude(true),
                    setUpdateLongitude(true),
                    setUpdateAntinodeLatitude(true),
                    setUpdateAntinodeLongitude(true),
                    setUpdateState(true),
                    setUpdateStateAbbreviation(true),
                    setUpdateWeather(true),
                    setUpdateCurrentTemp(true),
                    setUpdateTempRange(true);
                }}
              >
